...
routerInstance.get('', async (req,res,next)=>{
    res.json({code:200,message:"Sucess",data:"data"});
});

routerInstance.get('/user',async (req,res,next)=>{
    let user = await userHandler.getallUser();
    res.json({code:200,message:"Sucesss",data:user});
});
